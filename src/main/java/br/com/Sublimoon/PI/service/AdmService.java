...
public class AdmService {
    ...
    public void createAdm(final Adm adm){
        ...
        Assert.isTrue(! adm.getUserAdm().equals(""), "O campo de usuario do administrador não pode ser nulo");
        ...
        Assert.isTrue( !adm.getSenhaAdm().equals(""), "O campo senha não pode ser nulo");
        Assert.isTrue(adm.getSenhaAdm().length() <= 20, "Senha deve conter até 20 caracteres");

        Assert.isTrue(!adm.getTelefone().equals(""), "O campo telefone não pode ser nulo");
        ...
        Assert.isTrue(!adm.getEmail().equals(""), "O campo e-mail não pode ser nulo");
